...
#DOCKER:ENV GOLANG_VERSION=1.14.4
#DOCKER:ENV GOPATH=/go
#DOCKER:ENV PATH=/go/bin:/usr/local/go/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin
#DOCKER:WORKDIR /go
